...
const RecentBlogPost = ({ post }) => {
	return (
		<>
			<div className="flex p-3 border dark:border-gray-500">
				...
				<div>
					<div className="">
						...
						<div className=" flex flext-start   pt-4 pb-2">
							<p className=" dark:text-gray-500 flex flex-row   "><BiComment className="dark:text-gray-500 mt-1 font-bold" />  <span className="ml-1" > 3</span></p>
							<p className="flex felx-row mx-4"><BsEye className="dark:text-gray-500 mt-1 font-bold" /> <span className="ml-1 dark:text-gray-500">14,2K</span></p>
						</div>
					</div>
