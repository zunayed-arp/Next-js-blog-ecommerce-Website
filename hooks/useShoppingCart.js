...
import useLocalStorageReducer from "./useReducer";
...
// 		...state,
// 		cartDetails: {
// 			...state.cartDetails, [product.id]: entry
// 		},
// 		cartCount: Math.max(0, state.cartCount + quantity),
// 		totalPrice: Math.max(state.totalPrice + product.price * quantity),
// 	};
...
// 		return state;
// 	}
// 	let entry = state?.cartDetails?.[product.id + product.title];
...
// 				cartDetails: details,
// 				cartCount: Math.max(0, state.cartCount - entry.quantity),
// 				totalPrice: Math.max(0, state.totalPrice - product.price * entry.quantity
// 				),
// 			};
// 		}
